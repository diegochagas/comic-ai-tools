...
> Copie esta pasta (`gerar-paginas/_template/`) para `projects/<nome-do-projeto>/` na raiz do repo, preencha este arquivo e
> o `project.json`, e adicione os assets abaixo. Depois rode
> `python3 gerar-paginas/scripts/split_scripts.py -p <nome-do-projeto>`.

#!/usr/bin/env python3
"""Annotate a page image with numbered boxes for every layer in a JSON list
(the output of list_layers.mjs / list_text_layers.mjs), upscaled 2x, so the
layer indices can be matched to balloons by eye.

Usage: python annotate_text_boxes.py <image> <layers.json> <out.png>
"""
import sys, json
